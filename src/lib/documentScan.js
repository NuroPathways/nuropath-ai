      ...
      goals: {
        ...
        items: {
          ...
          properties: {
            ...
            timeline: {
              type: "string",
              enum: ["daily", "weekly", "biweekly", "monthly", "every_3_months", "every_6_months", "yearly"]
            }
          },
          required: ["title"]
        }
      ...
      for (const goal of extractedGoals) {
        if (goal.title && !existingTitles.has(goal.title.toLowerCase())) {
          await base44.entities.RewardToken.create({
            ...
            frequency: goal.timeline || undefined,
            progress: 0,
            target: 10,
            source: "document",
